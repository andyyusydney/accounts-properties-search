...
var selectAccount = exports.selectAccount = function selectAccount(id) {
	return {
		type: 'SELECT_ACCOUNT',
		id: id
	};
...
var selectProperty = exports.selectProperty = function selectProperty(id) {
	return {
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(17),A=__webpack_require__(4),B=__webpack_require__(2),ca=__webpack_require__(18),da=__webpack_require__(19),ea=__webpack_require__(20),ha=__webpack_require__(21),ia=__webpack_require__(22),C=__webpack_require__(7);
...
var _accounts = __webpack_require__(75);

var _accounts2 = _interopRequireDefault(_accounts);

var _selectedAccountId = __webpack_require__(76);

var _selectedAccountId2 = _interopRequireDefault(_selectedAccountId);

var _selectedPropertyId = __webpack_require__(77);

var _selectedPropertyId2 = _interopRequireDefault(_selectedPropertyId);
...
var rootReducer = (0, _redux.combineReducers)({
	...
	selectedAccountId: _selectedAccountId2.default,
	selectedPropertyId: _selectedPropertyId2.default,
...
var selectedAccountId = function selectedAccountId() {
...
exports.default = selectedAccountId;
...
var selectedPropertyId = function selectedPropertyId() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
	var action = arguments[1];
...
exports.default = selectedPropertyId;
...
var _VisibleList = __webpack_require__(80);
...
var _AccountsPropertiesList = __webpack_require__(81);

var _AccountsPropertiesList2 = _interopRequireDefault(_AccountsPropertiesList);
...
var getVisibleList = function getVisibleList(accounts, searchText) {
	...
	if (filteredAccounts.length < 1) {
		...
		filteredAccounts = accounts.filter(function (acc) {
			return acc.AccountName.includes(searchText);
		});
	}
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		...
		fetchData: function fetchData() {
			return dispatch(actions.accountsFetchData());
		}
	};
};

var VisibleList = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_AccountsPropertiesList2.default);
...
var AccountsPropertiesList = function (_React$Component) {
	_inherits(AccountsPropertiesList, _React$Component);

	function AccountsPropertiesList() {
		_classCallCheck(this, AccountsPropertiesList);

		return _possibleConstructorReturn(this, (AccountsPropertiesList.__proto__ || Object.getPrototypeOf(AccountsPropertiesList)).apply(this, arguments));
	}

	_createClass(AccountsPropertiesList, [{
			...
			if (this.props.accounts.length > 0) {
				if (this.props.selectedAccountId) {
					var currAccounts = this.props.accounts.filter(function (acc) {
						return acc.AccountId === _this2.props.selectedAccountId;
					});
	...
	return AccountsPropertiesList;
}(_react2.default.Component);

exports.default = AccountsPropertiesList;
...
var List = function List(_ref) {
	var itemsArr = _ref.itemsArr,
	    currAccountName = _ref.currAccountName,
	...
	return _react2.default.createElement(
		...
		itemsArr.map(function (item) {
			var selected = false;
			var Id = item.AccountId || item.Id;
			var name = item.AccountName || item.Name;
			if (Id === selectedItemId) selected = true;
			return _react2.default.createElement(_ListItem2.default, _extends({ key: Id, Id: Id, name: name, currAccountName: currAccountName, selected: selected }, item, { onClick: onClick }));
		})
	);
};

List.propTypes = {
	itemsArr: _propTypes2.default.arrayOf(_propTypes2.default.shape({
		Id: _propTypes2.default.number,
		AccountId: _propTypes2.default.number,
		name: _propTypes2.default.string,
		AccountName: _propTypes2.default.string
	}).isRequired).isRequired,
	currAccountName: _propTypes2.default.string.isRequired,
	selectedItemId: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]),
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			{ href: '#', onClick: function onClick(e) {
					e.preventDefault();
					_onClick(Id, currAccountName, name);
				} },
			name
		)
	);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./visibleList.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./visibleList.scss");
...
// module
exports.push([module.i, ".content {\n  width: 100%;\n  border-collapse: collapse;\n  padding: 10px 20px; }\n  .content__header {\n    color: #fff;\n    background-color: #007bff; }\n    .content__header-item {\n      width: 50%; }\n  .content__body {\n    background-color: #d9edf7; }\n    .content__body-item {\n      vertical-align: top; }\n  .content__header-item, .content__body-item {\n    padding: 8px;\n    border-top: 1px solid #fff;\n    border-left: 1px solid #fff;\n    border-right: 1px solid #fff; }\n    .content__header-item ul, .content__body-item ul {\n      padding-left: 0;\n      list-style: none;\n      margin: 6px; }\n      .content__header-item ul a, .content__body-item ul a {\n        text-decoration: none; }\n        .content__header-item ul a:hover, .content__body-item ul a:hover {\n          text-decoration: underline; }\n      .content__header-item ul .selected > a, .content__body-item ul .selected > a {\n        text-decoration: underline; }\n", ""]);
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement('input', {
        ...
        onChange: function onChange(e) {
          dispatch((0, _actions.search)(e.currentTarget.value));
        }
      }),
      _react2.default.createElement(
        'button',
        { type: 'button', className: 'search__clear', onClick: function onClick(e) {
